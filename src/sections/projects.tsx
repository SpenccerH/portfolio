        ...
        <div className="flex flex-col py-20">
            ...
            <div className="flex flex-row gap-x-8 justify-center items-center mt-10">
                {projects.map(project => (
                    <div className="bg-white w-[350px] h-[475px] rounded-xl px-2.5 pt-2.5 pb-6 flex flex-col justify-between">
                        <div className="flex flex-col">
                            <img src={project.image} className="rounded-lg w-full h-32 border" />
                            <div className="px-2.5 py-4">
                                <div className="flex flex-wrap gap-2">
                                    {project.tools.map(tool => (
                                        <div className="bg-subgray text-xs rounded-2xl px-2.5 py-1">{tool}</div>
                                    ))}
                                </div>
                            </div>
